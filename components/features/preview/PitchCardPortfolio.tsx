    ...
    return (
        <section className="mb-10">
            ...
            <div className="space-y-3">
                <a href="#" className="group block p-1 rounded-2xl transition-all duration-300 hover:bg-neutral-100">
                    <div className="flex items-center p-2 gap-4 sm:p-3">
                        <div className="w-12 h-12 rounded-xl bg-neutral-50 border border-neutral-200 flex items-center justify-center shrink-0 group-hover:border-neutral-300 transition-colors shadow-sm">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-neutral-500 mt-1 line-clamp-1 font-normal">
                                Modernized UI with improved responsiveness.
                            </p>
                        </div>
